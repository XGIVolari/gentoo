...
inherit libtool linux-info multilib-minimal verify-sig
...
IUSE="brotli +cxx dane doc examples +idn ktls nls +openssl pkcs11 seccomp sslv2 sslv3 static-libs test test-full +tls-heartbeat tools zlib zstd"
